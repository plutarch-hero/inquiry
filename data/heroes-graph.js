const heroGraphData = {
  theseus: {
    nodes: [
      ...
      { id: "menesteus", name: "메네스테우스", axis: "tragedy", shapeType: "person", type: "경쟁자", desc: "아테나이의 귀족", insight: "테세우스의 부재를 틈타 아테나이 민중을 선동하여 귀환한 테세우스를 에우보이아 지방으로 몰아내게 한 주동자" },
    ...
    links: [
      ...
      { source: "theseus", target: "sword_sandals", label: "징표 안치" },
